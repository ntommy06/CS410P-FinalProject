  ...
  componentDidMount() {
    ...
    getSchedule = () => {
        ...
        .then(async res => {
            ...
            // this.createList(res.data, numGames)

            //console.log(res.data.games[0].hTeam.triCode)
    ...
    appendGames = (data, schedIndex, logoArray) => {
      ...
      //These lines create the 3 column cells
      ...
      vs.innerText = data.games[schedIndex].homeStartTime
      ...
      scheduleTableBodyRow.append(HomeTeam, imaget1, vs, imaget2, AwayTeam) //append the data
